export default (function () {
  function dog_C(ARGS) {
    ...
    function funcVerify(value, type) {
      if (!type.name || type.name === 'check') return type(value);else if (type.name === 'Boolean') return typeof value === 'boolean';else if (type.name === 'String') return typeof value === 'string';else if (type.name === 'Number') return typeof value === 'number';else if (type.name === 'Object') return typeof value === 'object';else if (type.name === 'Function') return typeof value === 'function';else if (type.name === 'Symbol') return typeof value === 'symbol';else if (type.name === 'Array') return Object.prototype.toString.call(value) === '[object Array]';else if (type.name === 'Date') return Object.prototype.toString.call(value) === '[object Date]';else {
